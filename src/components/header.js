...
import Kswap from '../images/kswap_inline.png'
  ...
  return (
    <StyledHeader open={isMenuOpen}>
      ...
      <StyledNav ref={node} open={isMenuOpen}>
        ...
        {props.path !== undefined && <StyledTradeLink href="https://app.kimchiswap.io/">Launch App ↗</StyledTradeLink>}
      </StyledNav>
    </StyledHeader>
  )
}
