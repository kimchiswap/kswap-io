...
<Info>
KSWAPV1Router01 should not be used any longer, because of the discovery of a <Link to='/docs/v1/smart-contracts/router01#getamountin'>low severity bug</Link> and the fact that some methods do not work with tokens that take fees on transfer. The current recommendation is to use <Link to='/docs/v1/smart-contracts/router02'>KSWAPV1Router02</Link>.
</Info>

# Code

[`KswapV1Router01.sol`](https://github.com/Kimchiswap/Kswap-V1-Periphery/blob/master/contracts/KswapV1Router01.sol)

# Address

`KswapV1Router01` is deployed at `0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025` on the Ethereum [mainnet](https://etherscan.io/address/0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025), and the [Ropsten](https://ropsten.etherscan.io/address/0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025), [Rinkeby](https://rinkeby.etherscan.io/address/0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025), [Görli](https://goerli.etherscan.io/address/0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025), and [Kovan](https://kovan.etherscan.io/address/0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025) testnets. It was built from commit [2ad7da2](https://github.com/Kimchiswap/Kswap-V1-Periphery/tree/2ad7da28a6f70ec4299364bc1608af8f30e7646b).
...
```solidity
import '@kimchiswap/v1-periphery/contracts/interfaces/IKswapV1Router01.sol';
```
...
```typescript
import IKswapV1Router01 from '@kimchiswap/v1-periphery/build/IKswapV1Router01.json'
```
