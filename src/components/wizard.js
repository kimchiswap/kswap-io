...
const links = [
    ...
    sublinks: [
      {
        ...
        description: 'Simplify the process of integrating KSWAP into your project.',
        tag: 'reference',
        icon: '🖥️'
      },
      {
  ...
  },
  {
    ...
    sublinks: [
      {
        title: 'Anatomy of a KSWAP Pool',
        link: '/docs/v1/pools',
        description: 'An overview of what a KSWAP liquidity pool.'
      },
      {
    ...
    sublinks: [
      {
        ...
        description: 'A high level technical overview of the KSWAP protocol.'
      }
    ]
  }
]
