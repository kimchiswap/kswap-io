...
This documentation covers ERC-20 functionality for denominating pool tokens. For KSWAP-specific functionality, see <Link to='/docs/v1/smart-contracts/pair'>Pair</Link>.

# Code

[`KswapV1ERC20.sol`](https://github.com/Kimchiswap/kswap-v1-core/blob/master/contracts/KswapV1ERC20.sol)
...
```solidity
import '@kimchiswap/v1-core/contracts/interfaces/IKswapV1ERC20.sol';
```
...
```typescript
import IKswapV1ERC20 from '@kimchiswap/v1-core/build/IKswapV1ERC20.json'
```
